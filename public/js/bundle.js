...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"accountSettings.js":[function(require,module,exports) {
"use strict";
...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var buttonElementForUpdating, buttonTextForUpdating, url;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          buttonElementForUpdating = type === 'Password' ? document.querySelector('.form--user__passwordButton') : document.querySelector('.form--user__dataButton');
          buttonTextForUpdating = type === 'Password' ? 'Save Password' : 'Save Settings';
          _context.prev = 2;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"reviewAdding.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addingReview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var addingReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _axios.default)({
            url: "/api/v1/reviews/product/".concat(data.productId),
            method: 'POST',
            data: {
  ...
  return function addingReview(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.addingReview = addingReview;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addToCart.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var paymentOption = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _axios.default)({
            url: "api/v1/bookings/checkout-session/fromCart/".concat(obj),
            method: 'GET'
          });
        case 3:
          response = _context.sent;
          ...
          if (response.data.session.url) {
            (0, _alerts.showAlert)('success', "NEXT - Please pass all necessary credit card information!");
            window.setTimeout(function () {
  ...
  return function paymentOption(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _reviewAdding = require("./reviewAdding");
...
var addToCartButton = document.querySelector('.addToCart__button');
var removeFromCartButton = document.querySelector('#main--container__cart');
var addToCartSubmissionForm = document.querySelector('.addToCart__submission');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var formDataButton = document.querySelector('.form--user__dataButton').textContent = 'Updating...';
  var form = new FormData();
  form.append('name', document.getElementById('name').value);
  form.append('email', document.getElementById('email').value);
  document.getElementById('photo').files[0] ? form.append('photo', document.getElementById('photo').files[0]) : '';
  (0, _accountSettings.updateData)(form, 'Data');
...
if (userFormReview) {
  userFormReview.addEventListener('submit', function (e) {
    e.preventDefault();
    var title = document.getElementById('review--top__title').value;
    var description = document.getElementById('review__description').value;
    var rating = document.getElementById('rating').value;
    var userId = document.getElementById('adding__review').getAttribute('userid');
    var productId = document.getElementById('adding__review').getAttribute('productid');
    (0, _reviewAdding.addingReview)({
      title: title,
...
if (addToCartButton) {
  addToCartButton.addEventListener('click', function (e) {
    e.preventDefault();
    var url = addToCartButton.getAttribute('href');
    (0, _addToCart.addToCart)(url);
  });
}
if (removeFromCartButton) {
  removeFromCartButton.addEventListener('click', function (e) {
    var currentRemoveProductFromCart = e.target.closest('.addToCart a');
    var url = currentRemoveProductFromCart ? currentRemoveProductFromCart.getAttribute('url') : '';
    url ? (0, _addToCart.removeFromCart)(url) : '';
  });
}
if (addToCartSubmissionForm) {
  addToCartSubmissionForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var allIds = addToCartSubmissionForm.querySelectorAll('.addToCart') ? addToCartSubmissionForm.querySelectorAll('.addToCart') : '';
    var allQuatities = addToCartSubmissionForm.querySelectorAll('.addToCart') ? addToCartSubmissionForm.querySelectorAll('#Quantity') : '';
    var Obj = {};
    for (var index = 0; index < allIds.length; index++) {
      Obj[allIds[index].getAttribute('productid')] = allQuatities[index].value;
    }
    (0, _payment.paymentOption)(JSON.stringify(Obj));
    addToCartSubmissionForm.querySelector('.payment--mode__session button').textContent = 'Make Payment';
  });
}
},{"./login":"login.js","./accountSettings":"accountSettings.js","./reviewAdding":"reviewAdding.js","./addToCart":"addToCart.js","./payment":"payment.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
